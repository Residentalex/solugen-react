...
function formatTicketPOS(data, company, config) {
    const cfg = (0, ticketPlantillaConfig_1.normalizarConfig)(config);
                ...
                for (const det of detalles) {
                    ...
                    for (const linea of zona.lineas) {
                        ...
                        const texto = linea.mostrarLabel !== false
                            ? (linea.label || ticketPlantillaConfig_1.CAMPOS_DETALLE_LABELS[clave]) + ': ' + valor
                            : valor;
...
function formatTicketReciboIngreso(data, company, config) {
    const cfg = (0, ticketPlantillaConfig_1.normalizarConfigRI)(config);
    const width = cfg.opciones?.anchoLinea ?? LINE_LENGTH;
    const zonas = cfg.zonas || [];
    const cob = cfg.cobros || {};
            ...
            case 'detalle': {
                ...
                for (const doc of transacciones) {
                    ...
                    for (const linea of zona.lineas) {
                        ...
                        const texto = linea.mostrarLabel !== false
                            ? (linea.label || ticketPlantillaConfig_1.CAMPOS_DETALLE_RI_LABELS[clave]) + ': ' + valor
                            : valor;
...
function formatTicketVoucherVisanet(data, company, config) {
    const cfg = (0, ticketPlantillaConfig_1.normalizarConfigVSNT)(config);
