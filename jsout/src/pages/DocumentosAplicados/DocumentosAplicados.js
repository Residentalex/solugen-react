...
const DocumentosAplicados = () => {
    const setActiveModule = useUIStore((s) => s.setActiveModule);
    const resetToolbar = useUIStore((s) => s.resetToolbar);
    useScreenConfig('RDocAplicado');
    const config = useMemo(() => ({
        modulo: 'RDocAplicado',
        fetchDatos: documentosReporteApi.obtenerAplicados,
        reporteBlob: (sucursal, desde, hasta) => documentosReporteApi.imprimirReporte(sucursal, 'aplicados', desde, hasta),
        tituloReporte: 'Aplicados',
    }), []);
    ...
    return (_jsxs(_Fragment, { children: [loadingError && (_jsx(ListadoErrorAlert, { message: "Error al cargar documentos aplicados", onRetry: handleRefresh })), _jsxs(Card, { className: "paces-card-erp", style: { borderRadius: 8, overflow: 'hidden' }, styles: { body: { padding: 0 } }, children: [_jsx("div", { style: { padding: '16px 24px 0' }, children: _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16, flexWrap: 'wrap' }, children: [_jsx(RangePicker, { value: fechas, onChange: (dates) => handleFechasChange(dates), format: "DD/MM/YYYY", allowClear: false, presets: [
                            ...
                            emptyText: hasQueried
                                ? (_jsx(Empty, { description: _jsxs("span", { children: ["No hay documentos aplicados en el per\u00EDodo", _jsx("br", {}), _jsxs(Text, { type: "secondary", style: { fontSize: 12 }, children: [fechas[0].format('DD/MM/YYYY'), " \u2014 ", fechas[1].format('DD/MM/YYYY')] })] }) }))
