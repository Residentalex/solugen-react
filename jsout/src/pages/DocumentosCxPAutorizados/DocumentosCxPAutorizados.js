...
const DocumentosCxPAutorizados = () => {
    ...
    const config = useMemo(() => ({
        modulo: 'RDocCxPAutorizado',
        fetchDatos: (sucursal, desde, hasta) => documentosCxPReporteApi.obtenerAutorizados(sucursal, MODULO_ID, desde, hasta, tipoDocumento || undefined),
        reporteBlob: (sucursal, desde, hasta) => documentosCxPReporteApi.imprimirReporte(sucursal, MODULO_ID, 'autorizados', desde, hasta, tipoDocumento || undefined),
    ...
    return (_jsxs(_Fragment, { children: [loadingError && (_jsx(ListadoErrorAlert, { message: "Error al cargar documentos CXP autorizados", onRetry: handleRefresh })), _jsxs(Card, { className: "paces-card-erp", style: { borderRadius: 8, overflow: 'hidden' }, styles: { body: { padding: 0 } }, children: [_jsx("div", { style: { padding: '16px 24px 0' }, children: _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16, flexWrap: 'wrap' }, children: [_jsx(RangePicker, { value: fechas, onChange: (dates) => handleFechasChange(dates), format: "DD/MM/YYYY", allowClear: false, presets: [
                            ...
                            emptyText: hasQueried
                                ? (_jsx(Empty, { description: _jsxs("span", { children: ["No hay documentos CXP autorizados en el per\u00EDodo", _jsx("br", {}), _jsxs(Text, { type: "secondary", style: { fontSize: 12 }, children: [fechas[0].format('DD/MM/YYYY'), " \u2014 ", fechas[1].format('DD/MM/YYYY')] })] }) }))
