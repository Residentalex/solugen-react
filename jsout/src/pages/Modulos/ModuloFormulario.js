...
const ModuloFormulario = () => {
    ...
    const mode = id && id !== 'nuevo' ? 'editar' : 'crear';
    useEffect(() => {
    ...
    return (_jsxs(Card, { className: "paces-card-erp", style: { borderRadius: 8 }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: 24 }, children: [_jsx(Text, { strong: true, style: { fontSize: 16 }, children: mode === 'crear' ? 'Nuevo Módulo' : 'Editar Módulo' }), _jsxs("div", { style: { display: 'flex', gap: 8 }, children: [_jsx(Button, { icon: _jsx(CloseOutlined, {}), onClick: handleCancelar, children: "Cancelar" }), _jsx(Button, { type: "primary", icon: _jsx(SaveOutlined, {}), onClick: handleGuardar, loading: saving, children: "Guardar" })] })] }), _jsxs(Form, { form: form, layout: "vertical", size: "small", style: { maxWidth: 600 }, children: [_jsx(Form.Item, { name: "nombre", label: "Nombre del M\u00F3dulo", rules: [{ required: true, message: 'El nombre es requerido' }], children: _jsx(Input, { placeholder: "Ej: Generador ORC" }) }), _jsx(Form.Item, { name: "orden", label: "Orden", rules: [{ required: true, message: 'El orden es requerido' }], children: _jsx(InputNumber, { min: 0, max: 999, style: { width: '100%' } }) })] })] }));
};
