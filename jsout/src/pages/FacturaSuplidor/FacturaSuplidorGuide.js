...
const FacturaSuplidorGuide = ({ tipo, concepto, suplidor, total, ncf, suplidoresDisponibles, tipoRef, conceptoRef, suplidorRef, montoRef, ncfRef, sucursalRef, sucursal, }) => {
