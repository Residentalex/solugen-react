 ...
 */
export function imagenABits(img, anchoPx, altoPx) {
 ...
 */
export function generarGSV0Base64(bits, anchoBytes, alto) {
 ...
 */
export async function obtenerLogoEscPosBase64(logo) {
    if (!logo?.mostrar)
        return '';
