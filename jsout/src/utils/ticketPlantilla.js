 ...
 */
export async function obtenerConfigPlantilla(codigo) {
    if (cache.has(codigo)) {
 ...
 */
export async function obtenerConfigPorId(plantillaId) {
 ...
 */
export function limpiarCachePlantillaPorId(plantillaId) {
