...
export const CAMPOS_TICKET_LABELS = {
    NCF: 'NCF',
    TIPO_COMP: 'TIPO COMP',
    CAJERO: 'CAJERO',
    CAJA: 'CAJA',
...
export const CAMPOS_TICKET_LABELS_VSNT = {
    COMPANIA: 'Compañía',
    SUCURSAL: 'Sucursal',
    DIRECCION: 'Dirección',
    TELEFONO: 'Teléfono',
...
export const CAMPOS_DETALLE_LABELS = {
    CODIGO: 'Código',
    ARTICULO: 'Artículo',
    CANTIDAD: 'Cantidad',
    PRECIO: 'Precio',
...
export const CAMPOS_DETALLE_RI_LABELS = {
    DOCUMENTO: 'Documento',
...
export const ANCHO_LINEA_OPCIONES = [32, 42, 48];
export const PLANTILLA_CONFIG_DEFAULT = {
    encabezado: {
 ...
 */
export const PLANTILLA_CONFIG_DEFAULT_RI = {
 ...
 */
export const PLANTILLA_CONFIG_DEFAULT_VSNT = {
    encabezado: {
        mostrarCompania: true,
        mostrarDireccion: true,
        mostrarTelefono: true,
 ...
 */
export const PLANTILLA_CONFIG_DEFAULT_VSNT_ANULACION = {
 ...
 */
export const PLANTILLA_CONFIG_DEFAULT_VSNT_CIERRE = {
    encabezado: {
        mostrarCompania: true,
        mostrarDireccion: true,
        mostrarTelefono: true,
 ...
 */
export function normalizarTextosLibres(textos) {
    if (!textos)
        return undefined;
    const out = {};
...
function esItemOrdenRI(item) {
    return (CAMPOS_TICKET_ORDEN_RI.includes(item)
        || item === 'ESPACIO'
        || item === 'SEPARADOR'
...
export function normalizarConfig(config) {
    if (!config)
        return { ...PLANTILLA_CONFIG_DEFAULT, zonas: [...ZONAS_DEFAULT_FPV] };
 ...
 */
export function normalizarConfigRI(config) {
    if (!config)
        return { ...PLANTILLA_CONFIG_DEFAULT_RI, zonas: [...ZONAS_DEFAULT_FRI] };
 ...
 */
export function normalizarConfigVSNT(config) {
    if (!config)
        return { ...PLANTILLA_CONFIG_DEFAULT_VSNT, zonas: [...ZONAS_DEFAULT_VSNT] };
 ...
 */
export function normalizarConfigVSNT_ANULACION(config) {
    if (!config)
        return { ...PLANTILLA_CONFIG_DEFAULT_VSNT_ANULACION, zonas: [...ZONAS_DEFAULT_VSNT_ANULACION] };
 ...
 */
export function normalizarConfigVSNT_CIERRE(config) {
    if (!config)
        return { ...PLANTILLA_CONFIG_DEFAULT_VSNT_CIERRE, zonas: [...ZONAS_DEFAULT_VSNT_CIERRE] };
 ...
 */
export const CAMPOS_DTO_DISPONIBLES = {
    FPV: [
 ...
 */
export const ZONAS_DEFAULT_FPV = [
    {
 ...
 */
export const ZONAS_DEFAULT_FRI = [
    {
 ...
 */
export const ZONAS_DEFAULT_VSNT = [
    {
 ...
 */
export const ZONAS_DEFAULT_VSNT_ANULACION = [
    {
 ...
 */
export const ZONAS_DEFAULT_VSNT_CIERRE = [
    {
 ...
 */
export function migrarConfigAZonas(config, tipo) {
