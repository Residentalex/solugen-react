export const ESTADO_DOCUMENTO_MAP = {
...
export const ESTADO_DOCUMENTO_LABEL_MAP = {
...
const PERIODO_NUM_MAP = {
    'Abierto': 5,
    'Cerrado': 6,
};
export function toEstadoNum(estado) {
    if (estado == null)
        return -1;
...
export function toPeriodoNum(periodo) {
    if (periodo == null)
        return -1;
...
export function resolveEstado(estado) {
