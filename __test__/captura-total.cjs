...
var casos = [
  { nombre: "fpv_sin_config", salida: formatTicketPOS(datosEjemploPOS, companyEjemplo, void 0) },
  { nombre: "fri_sin_config", salida: formatTicketReciboIngreso(datosEjemploRecibo, companyEjemplo, void 0) },
...
for (const c of casos) {
  (0, import_node_fs.writeFileSync)((0, import_node_path.join)(dir, c.nombre + ".raw.txt"), c.salida, "latin1");
  (0, import_node_fs.writeFileSync)((0, import_node_path.join)(dir, c.nombre + ".leido.txt"), legible(c.salida), "utf8");
