...
const DocumentosCxPAplicados: React.FC = () => {
  ...
  const config = useMemo(() => ({
    modulo: 'RDocCxPAplicado' as const,
    fetchDatos: (sucursal: number, desde: string, hasta: string) =>
      documentosCxPReporteApi.obtenerAplicados(sucursal, MODULO_ID, desde, hasta, tipoDocumento || undefined),
    reporteBlob: (sucursal: number, desde: string, hasta: string) =>
      documentosCxPReporteApi.imprimirReporte(sucursal, MODULO_ID, 'aplicados', desde, hasta, tipoDocumento || undefined),
  ...
  return (
    <>
      {loadingError && (
        <ListadoErrorAlert
          message="Error al cargar documentos CXP aplicados"
            ...
            emptyText: hasQueried
              ? (
                <Empty
                  description={
                    <span>
                      No hay documentos CXP aplicados en el período
                      <br />
