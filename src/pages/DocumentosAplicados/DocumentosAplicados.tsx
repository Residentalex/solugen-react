...
const DocumentosAplicados: React.FC = () => {
  ...
  return (
    <>
      {loadingError && (
        <ListadoErrorAlert
          message="Error al cargar documentos aplicados"
            ...
            emptyText: hasQueried
              ? (
                <Empty
                  description={
                    <span>
                      No hay documentos aplicados en el período
                      <br />
